...
use crate::{
    models::{
        cache::CacheEntry,
        telemetry::{
            DriverLapGraph, FastestLapSector, PacePoint, QualifyingRankings, DriverMetrics,
        },
    },
...
pub struct AppState {
    ...
    pub fetch_driver_telemetry_cache: DashMap<String, CacheEntry<Vec<DriverMetrics>>>,
